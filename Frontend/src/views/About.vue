<template>
  <main id="about">
    <img @click="showMenu" class="navIcon" src="./../assets/navicon.png" alt="navIcon">
    <h2>Vårt kaffe</h2>
    <article id="aboutText">
      <p id="bold">Pumpkin spice mug, barista cup, sit macchiato, kopi-luwak, doppio, grounds dripper, crema, strong whipped, variety extra iced id lungo half and half mazagran. Pumpkin spice.</p>
    ...
    <section class="founder">
      <img src="./../assets/image 1.jpg" alt="Eva Cortado" id="imgEva">
      <h3>Eva Cortado</h3>
      <h6>VD & Grundare</h6>
    </section>
